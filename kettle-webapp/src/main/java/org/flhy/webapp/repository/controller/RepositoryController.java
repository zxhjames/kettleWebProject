...
public class RepositoryController {
	...
	protected void createTrans(@RequestParam String dir, @RequestParam String transName,@RequestParam String[] taskGroupArray) throws Exception {
		boolean isSuccess=false;
		// 这个是空
		KettleEnvironment.init();
		org.flhy.ext.core.PropsUI.init( "KettleWebConsole", Props.TYPE_PROPERTIES_KITCHEN );
